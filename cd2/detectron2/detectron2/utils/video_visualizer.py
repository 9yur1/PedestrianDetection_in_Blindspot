...
class VideoVisualizer:
    ...
    def draw_instance_predictions(self, frame, predictions, prev_jukim=None):
        """
        ...
        frame_visualizer.overlay_instances(
            ...
            prev_boxes_ju=prev_jukim,
            alpha=alpha,
        )

        return frame_visualizer.output, frame_visualizer.output.prev_box_visimg
